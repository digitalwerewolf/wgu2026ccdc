...
def deploy_from_config(config):
    ...
    print(f"    2. You set up vwire/L3 interfaces manually")
    print(f"    3. You created an Allow-All-Temp rule")
    print(f"    4. You verified scored services work")
    print(f"    5. The mgt interface is NOT in the vwire")
